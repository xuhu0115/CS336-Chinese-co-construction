...
我帮你把 **11.1.2 特殊领域数据** 这部分内容扩展成 **详细教程风格、结构清晰、带解释与实例的版本**，便于读者理解每类数据的意义、使用方法和注意事项：
...
<img width="1100" height="500" alt="769c080727bbc323c6f12105a93a96a3" src="https://github.com/user-attachments/assets/7272170a-d035-4555-bb52-f43190f625be" />
