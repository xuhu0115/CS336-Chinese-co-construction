...
<center class="half">
    <img src="./chapter9/images/9-1-引用贝尔实验室论文.png" width="400"/>
    <img src="./chapter9/images/9-1-训练数据与损失.png" width="400"/>
...
<div align="center">
   <img src="./chapter9/images/9-2-混淆集消歧任务上的学习曲线.png" />
...
<center class="half">
    <img src="./chapter9/images/9-3-使用不同的曲线簇对测试数据集进行曲线拟合.png" width="400"/>
    <img src="./chapter9/images/9-3-曲线簇.png" width="400"/>
...
<center class="half">
    <img src="./chapter9/images/9-4-神经机器翻译学习曲线.png" width="500"/>
    <img src="./chapter9/images/9-4-幂律学习曲线示意图.png" width="250"/>
    <p>图9.4 神经机器翻译学习曲线</p>
</center>
...
<div align="center">
   <img src="./chapter9/images/9-5-Hestness（2017）提出的关键概念.png" />
...
<div align="center">
   <img src="./chapter9/images/9-6-随着模型规模、数据集规模和训练所用计算资源的增加，语言建模性能稳步提升.png" />
...
<div align="center">
   <img src="./chapter9/images/9-7-训练数据和测试数据不同源下的缩放定律.png" />
...
<div align="center">
    <img src="./chapter9/images/9-4-幂律学习曲线示意图.png" width="500"/>
    <p>图9.8 神经机器翻译学习曲线</p>
</div>
...
<div align="center">
    <img src="./chapter9/images/9-9-数据大小与模型误差之间的幂律关系.png" width="500"/>
...
<div align="center">
    <img src="./chapter9/images/9-10-三种不同任务的缩放指数.png" width="500"/>
...
<div align="center">
    <img src="./chapter9/images/9-11-维度与scaling laws斜率之间的关系.png" width="500"/>
...
<div align="center">
    <img src="./chapter9/images/9-12-数据组成只影响偏移量.png" width="500"/>
...
<div align="center">
    <img src="./chapter9/images/9-13-数据混合比例如何影响缩放定律.png" width="500"/>
...
<div align="center">
    <img src="./chapter9/images/9-14-重复数据与新数据对模型性能的影响.png" width="500"/>
...
<div align="center">
    <img src="./chapter9/images/9-15-大数据下的数据选择策略.png" width="500"/>
...
<div align="center">
    <img src="./chapter9/images/9-16-不同参数规模下Transformer 和 LSTM 性能的对比.png" width="500"/>
...
<div align="center">
    <img src="./chapter9/images/9-17-不同模型及架构的计算-性能（FLOPs vs 性能）图.png" width="500"/>
...
<div align="center">
    <img src="./chapter9/images/9-18-Transformer 及其各种变体的计算量与性能之间的关系.png" width="500"/>
...
<div align="center">
    <img src="./chapter9/images/9-19-优化器对比.png" width="500"/>
    <p>图9.19 优化器对比</p>
</div>
...
<div align="center">
    <img src="./chapter9/images/9-20-layers数量对模型性能的影响.png" width="500"/>
...
<div align="center">
    <img src="./chapter9/images/9-21-模型的宽度和深度对性能的影响.png" width="500"/>
...
<div align="center">
    <img src="./chapter9/images/9-22-批量大小与临界值.png" width="500"/>
    <p>图9.22 批量大小与临界值</p>
</div>
...
<div align="center">
    <img src="./chapter9/images/9-23-临界批量大小与模型性能.png" width="500"/>
...
<div align="center">
    <img src="./chapter9/images/9-24-选择最优的批量大小.png" width="500"/>
    <p>图9.24 选择最优的批量大小</p>
</div>
...
<div align="center">
    <img src="./chapter9/images/9-25-标准做法与μP的改进.png" width="500"/>
...
<div align="center">
    <img src="./chapter9/images/9-26-μP的不同实现.png" width="500"/>
    <p>图9.26 μP的不同实现</p>
</div>
...
<div align="center">
    <img src="./chapter9/images/9-27-scaling 在不同的下游任务上表现不同.png" width="500"/>
...
<div align="center">
    <img src="./chapter9/images/9-28-参数_计算_数据的联合缩放.png" width="500"/>
...
<center class="half">
    <img src="./chapter9/images/9-29-不同算力预算下模型大小与性能的关系.png" width="400"/>
    <img src="./chapter9/images/9-29-不同算力预算下模型大小与性能的关系2.png" width="400"/>
...
<center class="half">
    <img src="./chapter9/images/9-30-扩散模型的缩放法则1.png" width="400"/>
    <img src="./chapter9/images/9-30扩散模型的缩放法则2.png" width="200"/>
...
<div align="center">
    <img src="./chapter9/images/9-31-使用mμP展现了更稳定的扩展规律.png" width="500"/>
...
<div align="center">
    <img src="./chapter9/images/9-32-使用mμP展现了更可预测的扩展规律.png" width="500"/>
...
<div align="center">
    <img src="./chapter9/images/9-33-SP和mμP的详细实现细节比较.png" width="500"/>
...
<div align="center">
    <img src="./chapter9/images/9-34-在小模型对三个关键超参数进行随机超参数搜索.png" width="500"/>
...
<div align="center">
    <img src="./chapter9/images/9-35-MiniCPM与其他SOTA模型的性能比较.png" width="500"/>
...
<div align="center">
    <img src="./chapter9/images/9-36-使用muP稳定扩展.png" width="500"/>
    <p>图9.36 使用muP稳定扩展</p>
</div>
...
<div align="center">
    <img src="./chapter9/images/9-37-缩放曲线中的模型配置和训练配置.png" width="500"/>
...
<div align="center">
    <img src="./chapter9/images/9-38-三种不同规模模型使用不同批次大小进行训练的损失曲线.png" width="500"/>
...
<div align="center">
    <img src="./chapter9/images/9-39-连接最有批次大小.png" width="500"/>
    <p>图9.39 连接最优批次大小</p>
</div>
...
<div align="center">
    <img src="./chapter9/images/9-40-MiniCPM使用mμP保持了学习率的稳定性.png" width="500"/>
...
<div align="center">
    <img src="./chapter9/images/9-41-学习率策略比较.png" width="500"/>
    <p>图9.41 学习率策略比较</p>
</div>
...
<div align="center">
    <img src="./chapter9/images/9-42-模型训练损失在WSD的衰减阶段突然下降.png" width="500"/>
...
<div align="center">
    <img src="./chapter9/images/9-43-验证集损失与计算量的关系.png" width="500"/>
...
<div align="center">
    <img src="./chapter9/images/9-44-使用WSD在三种任务上进行扩展实验的结果.png" width="500"/>
...
<div align="center">
    <img src="./chapter9/images/9-45-使用WSD在三种任务上进行扩展实验的fit结果.png" width="500"/>
...
<div align="center">
    <img src="./chapter9/images/9-46-在不同模型规模和不同下游任务上使用WSD的缩放曲线.png" width="500"/>
...
<div align="center">
    <img src="./chapter9/images/9-47-DeepSeek与其他SOTA模型的性能比较.png" width="500"/>
...
<div align="center">
    <img src="./chapter9/images/9-48-给定预算下批次大小和学习率的组合.png" width="500"/>
...
<div align="center">
    <img src="./chapter9/images/9-49-不同计算预算下最优批次大小和最优学习率的变化趋势.png" width="500"/>
...
<div align="center">
    <img src="./chapter9/images/9-50-不同学习率调度器对训练损失的影响.png" width="500"/>
...
<div align="center">
    <img src="./chapter9/images/9-51-计算预算-模型规模和数据规模之间的Scaling-Law.png" width="500"/>
...
<div align="center">
    <img src="./chapter9/images/9-52-DeepSeek在不同训练计算预算下在验证集上的性能表现.png" width="500"/>
...
<div align="center">
    <img src="./chapter9/images/9-53-Llama3的IsoFLOPs的Scaling-Law曲线.png" width="500"/>
...
<div align="center">
    <img src="./chapter9/images/9-54-对ARC-Challenge的Scaling-law预测.png" width="500"/>
...
<div align="center">
    <img src="./chapter9/images/9-55-Hunyuan混合专家模型的Scaling-Law.png" width="500"/>
...
<div align="center">
    <img src="./chapter9/images/9-56-MinMax-Scaling-Laws.png" width="500"/>
